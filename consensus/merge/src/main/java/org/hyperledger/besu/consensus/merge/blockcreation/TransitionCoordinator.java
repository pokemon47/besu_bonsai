...
public class TransitionCoordinator extends TransitionUtils<MiningCoordinator>
  ...
  public Optional<Block> createBlock(
    ...
    return dispatchFunctionAccordingToMergeState(
        (MiningCoordinator coordinator) ->
            coordinator.createBlock(parentHeader, transactions, ommers));
  }
  ...
  public Optional<Block> createBlockForReplay(
    ...
    if (sourceBlock.getHeader().getDifficulty().equals(Difficulty.ZERO)) {
      return mergeCoordinator.createBlockForReplay(parentHeader, sourceBlock);
    }
    return miningCoordinator.createBlockForReplay(parentHeader, sourceBlock);
  }
  ...
  public Optional<Block> createBlockForReplayMerge(
    ...
    return mergeCoordinator.createBlockForReplayMerge(
        parentHeader, transactions, prevRandao, timestamp, withdrawals, parentBeaconBlockRoot);
  }
